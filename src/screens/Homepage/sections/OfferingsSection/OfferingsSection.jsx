  ...
  return (
    <section className="relative w-full z-10 py-6 xs:py-8 sm:py-10 md:py-12 lg:py-16 xl:py-20 pb-16 xs:pb-18 sm:pb-20 md:pb-24 lg:pb-28 xl:pb-32 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-y-0 left-0 w-[600px] max-w-[90vw] pointer-events-none">
        ...
        <svg
          className="absolute bottom-[-2%] left-0 h-[290px] sm:h-[400px] z-[-1] w-auto block min-[950px]:hidden"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 452 531">
          ...
          <image href={MarketingImg} x="52" y="10" width="84" height="84" />
        ...
        <image href={Pen} alt="Graphic Design" x="380" y="392" width="75" height="75" />
      ...
      <div className="absolute sm:-top-[65px]  sm:right-[-90px] sm:w-[330px] sm:h-[370px] h-[250px] top-[-45px] right-[-60px] w-[230px] pointer-events-none block min-[950px]:hidden">
        ...
        >
          ...
          <image href={Idea} x="-50" y="100" width="100" height="100" className="-scale-x-100" />
      ...
      <div className="relative w-[90%] xs:w-[85%] sm:w-[80%] md:w-[75%] lg:w-[70%] xl:w-[65%] 2xl:w-[60%] max-w-[1200px] z-10">
        <div className="p-4 xs:p-6 sm:p-8 md:p-10 lg:p-12 xl:p-16 flex flex-col items-center gap-4 xs:gap-5 sm:gap-6 md:gap-7 lg:gap-8 xl:gap-10">
          ...
          <p className="opacity-75 font-['Poppins',Helvetica] z-[10] font-normal text-[#1F1F1F] text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl leading-5 xs:leading-6 sm:leading-7 md:leading-8 lg:leading-9 xl:leading-10 text-center px-2 sm:px-4 md:px-6 lg:px-8">
            {lang === 'ar' ? (
              <>
                <span className="block sm:inline">نحن هنا لتحويل أفكارك إلى واقع ملموس! سواء كنت تملك</span>
                <span className="block sm:inline">رؤية مبدئية أو</span>
                <span className="block sm:inline">خطة جاهزة، فريقنا المتخصص مستعد لدعمك في كل خطوة من رحلتك.</span>
              </>
            ) : (
              <>
                <span className="block sm:inline">We're here to turn your ideas into reality whether you have!</span>
                <span className="block sm:inline">an initial concept or</span>
                <span className="block sm:inline">a ready-made plan, our specialized team is ready to support you every step of the way.</span>
          ...
          <div className="relative w-full z-[-1]">
            {lang === 'ar' ? (
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="hidden lg:block absolute  md:top-[-75px] xl:top-[-80px] z[-10] left-1/2 transform -translate-x-1/2 translate-x-[25%] w-32 sm:w-36 md:w-40 lg:w-44 xl:w-48 2xl:w-52 h-auto"
                viewBox="0 0 171 11"
                fill="none"
              >
                <path
              ...
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="hidden lg:block absolute top-[-110px] xl:top-[-125px] left-1/2 transform -translate-x-1/2 -translate-x-[25%] w-32 sm:w-36 md:w-40 lg:w-44 xl:w-48 2xl:w-52 h-auto"
                viewBox="0 0 171 11"
                fill="none"
              >
                <path
