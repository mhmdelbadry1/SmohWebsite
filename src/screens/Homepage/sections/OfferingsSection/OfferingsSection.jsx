  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-4 relative w-full max-w-7xl mx-auto px-4">
        <h2 className="relative w-fit font-['Poppins',Helvetica] font-semibold text-black text-[56px] animate-fade-in">
          Our Projects
        </h2>
        <p className="opacity-75 font-['Poppins',Helvetica] text-xl text-center font-normal text-black max-w-4xl">
      ...
      <div className="absolute w-[100px] h-[100px] top-0 right-10 animate-spin-slow">
