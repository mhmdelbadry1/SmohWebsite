...
export const HeroBannerSection = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center bg-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[600px] max-w-[90vw] h-screen pointer-events-none z-10 transition-all duration-1000">
        <svg
        ...
        >
          ...
          {/* Star Icon inside SVG */}
          <g className="animate-svg-star-entrance">
            <image
              href={Star}
              x="36"
              y="45"
              width="90"
              height="90"
              className="animate-float-continuous animate-glow-white"
            />
          </g>
          
          {/* Facebook Icon inside SVG */}
          <g className="animate-svg-facebook-entrance">
            <image
              href={facebookIcon}
              x="92"
              y="340"
              width="85"
              height="85"
              className="animate-float-smooth animate-glow-facebook"
            />
          </g>
          
          {/* Bezier Design inside SVG */}
          <g className="animate-svg-bezier-entrance">
            <image
              href={bezierDesign}
              x="70"
              y="590"
      ...
      <div className="absolute top-[15%] hidden lg:block right-[-5%] h-screen w-auto max-w-[450px] pointer-events-none z-0">
        <svg
     ...
     <div className=" absolute top-[69%] fade-in left-[70%] w-[100px] h-[100px] animate-fade-in">
      ...
      <style>{`
        ...
        @keyframes glow-facebook {
          0%, 100% {
            filter: drop-shadow(0 0 4px rgba(24, 119, 242, 0.4))
                    drop-shadow(0 0 8px rgba(24, 119, 242, 0.3))
                    drop-shadow(0 0 12px rgba(24, 119, 242, 0.2));
          }
          50% {
            filter: drop-shadow(0 0 8px rgba(24, 119, 242, 0.6))
                    drop-shadow(0 0 16px rgba(24, 119, 242, 0.5))
                    drop-shadow(0 0 24px rgba(24, 119, 242, 0.3));
          }
        }

        .animate-glow-facebook {
          animation: glow-facebook 2.5s ease-in-out infinite;
        }
        ...
        /* SVG Icon entrance animations - designed specifically for SVG elements */
        @keyframes svg-star-entrance {
          0% {
            opacity: 0;
        ...
        @keyframes svg-facebook-entrance {
          0% {
            opacity: 0;
        ...
        .animate-svg-star-entrance {
          animation: svg-star-entrance 1.5s ease-out 0.5s forwards;
          opacity: 0;
          transform-origin: center;
        }

        .animate-svg-facebook-entrance {
          animation: svg-facebook-entrance 1.8s ease-out 1.2s forwards;
          opacity: 0;
          transform-origin: center;
        }

        .animate-svg-bezier-entrance {
          animation: svg-bezier-entrance 1.8s ease-out 0.5s forwards;
          opacity: 0;
          transform-origin: center;
        }
