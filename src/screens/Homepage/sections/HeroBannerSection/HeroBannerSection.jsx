...
export const HeroBannerSection = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-start  bg-white overflow-hidden ">
      ...
      <div className="absolute top-[15%] right-[-5%] h-full w-auto max-w-[450px] pointer-events-none z-0">
        <svg
      ...
      {/* Decorative icons positioned responsively */}
      <div className="absolute top-[5%] sm:top-[7%] left-[15%] sm:left-[20%] w-[40px] sm:w-[60px] h-[40px] sm:h-[60px] animate-float">
        <div className="w-full h-full bg-gradient-to-br from-pink-400 to-pink-500 rounded-full flex items-center justify-center shadow-lg">
      ...
      <div className="absolute top-[8%] sm:top-[10%] left-[25%] sm:left-[30%] w-[30px] sm:w-[40px] h-[30px] sm:h-[40px] animate-pulse">
        <div className="w-full h-full bg-gradient-to-br from-purple-400 to-purple-500 rounded-full shadow-lg"></div>
      </div>
      <div className="absolute top-[5%] sm:top-[6%] right-[15%] sm:right-[20%] w-[35px] sm:w-[50px] h-[35px] sm:h-[50px] animate-bounce">
      ...
      <div className="absolute top-[35%] sm:top-[40%] right-[5%] sm:right-[10%] w-[40px] sm:w-[60px] h-[40px] sm:h-[60px] animate-float">
        <div className="w-full h-full bg-gradient-to-br from-pink-400 to-pink-500 rounded-lg flex items-center justify-center shadow-lg">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
      ...
      <div className="absolute bottom-[10%] sm:bottom-[15%] right-[20%] sm:right-[25%] w-[35px] sm:w-[50px] h-[35px] sm:h-[50px] animate-pulse">
        <div className="w-full h-full bg-gradient-to-br from-pink-400 to-red-400 rounded-full flex items-center justify-center shadow-lg">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path
              d="M8 15C8 16.1 7.1 17 6 17C4.9 17 4 16.1 4 15C4 13.9 4.9 13 6 13C7.1 13 8 13.9 8 15ZM16 13C16 14.1 15.1 15 14 15C12.9 15 12 14.1 12 13C12 11.9 12.9 11 14 11C15.1 11 16 11.9 16 13ZM8 15V5L16 3V13"
              stroke="white"
              strokeWidth="1.5"
              fill="none"
            />
      ...
      <div className="absolute bottom-[15%] sm:bottom-[20%] left-[15%] sm:left-[20%] w-[40px] sm:w-[60px] h-[40px] sm:h-[60px] animate-bounce">
        <div className="w-full h-full bg-gradient-to-br from-blue-400 to-blue-500 rounded-lg flex items-center justify-center shadow-lg">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path
              d="M3 20H21M7 16V12M12 16V8M17 16V10"
              stroke="white"
              strokeWidth="2"
              strokeLinecap="round"
            />
      ...
      <div className="absolute bottom-[20%] sm:bottom-[25%] left-[10%] sm:left-[15%] w-[30px] sm:w-[40px] h-[30px] sm:h-[40px] animate-float">
        <div className="w-full h-full bg-gradient-to-br from-indigo-400 to-purple-400 rounded-lg flex items-center justify-center shadow-lg">
