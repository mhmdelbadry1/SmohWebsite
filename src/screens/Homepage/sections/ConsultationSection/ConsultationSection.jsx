...
export const ConsultationSection = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      const formData = {
        ...
        subject:
          lang === "ar"
            ? "طلب استشارة من شركة سمو للدعاية والإعلان"
            : "Consultation Request from Sumou Advertising & Marketing Company",
      };
  ...
  const copyrightInfo = [
    { text: "©", className: "[font-family:'SF_Pro_Text-Regular',Helvetica]" },
    {
      text:
        lang === "ar"
          ? "شركة سمو للدعاية والإعلان"
          : "Sumou Advertising & Marketing Company",
                ...
                <div className="space-y-4 text-sm leading-7">
                  {lang === "ar" ? (
                    <div dir="rtl">
                      ...
                      <p>
                        تحترم شركة سمو للدعاية والإعلان خصوصية زوار ومستخدمي
                ...
                <div className="space-y-4 text-sm leading-7">
                  {lang === "ar" ? (
                    <div dir="rtl">
                      ...
                      <p>
                        جميع الحقوق محفوظة لشركة سمو للدعاية والإعلان، بما في
                      ...
                      <p>
                        لا تتحمل شركة سمو أي مسؤولية عن أي أضرار مباشرة أو غير
